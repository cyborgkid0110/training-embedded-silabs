...
void app_iostream_usart_init(void)
{
  ...
  /**
   * Retarget I/O to USART by creating stream
   * Write: sys -> USART -> computer -> console
   * Read: computer -> USART -> sys
   */
  ...
  /** Using printf
   * retarget system I/O stream to standard I/O stream
   * if retarget is uninstall, stdio function won't work.
   * */
